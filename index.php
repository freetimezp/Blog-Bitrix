...
$APPLICATION->SetTitle("Блог на БИТРИКС"); ?>
    ...
    <div class="box1">
        <h3><a href="single.html">Making it look like readable English. Many desktop packages and web
                page</a></h3>
        ...
        <div class="data">
            <p>Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                ...
                packages and web page editorsLorem Ipsum is that it has a more-or-less normal distribution
